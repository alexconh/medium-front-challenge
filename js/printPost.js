const getPost = () => {
        ...
        postsLayout += `
            <article class="card mb-5">
                ...
                <div class="card-bottom mb-4 d-flex align-items-center justify-content-between">
                    ...
                    <input type="checkbox" name="save-card" class="save" id="save-${post}">
                    <label for="save-${post}">
                    ...
                    <div class="dropdown ms-2">
                        <!-- dropdown -->
                        <button class="btn-dark p-0" type="button" id="dropdownMenuButton1" data-bs-offset="-69,5" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    document.querySelector('#cards-container').innerHTML = postsLayout
